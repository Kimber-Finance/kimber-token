 ...
 */
contract MockKimberTokenV2 is GovernancePowerDelegationERC20, VersionedInitializable {
  using SafeMath for uint256;

  string internal constant NAME = 'Kimber Token';
  string internal constant SYMBOL = 'KIMBER';
  ...
  /// @dev reference to the Kimber governance contract to call (if initialized) on _beforeTokenTransfer
  /// !!! IMPORTANT The Kimber governance is considered a trustable contract, being its responsibility
  /// to control all potential reentrancies by calling back the KimberToken
 ...
 /**
  ...
  function _beforeTokenTransfer(
    ...
    // caching the kimber governance address to avoid multiple state loads
